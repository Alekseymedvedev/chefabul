...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<div class="cart-subtotal_inner ">
		<div class="cart-subtotal_box flex basket-totals">
			<div class="cart-subtotal">
				<span><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?>:</span>
				<span data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></span>
			</div>
			<a href="<?php echo  wc_get_page_permalink( 'shop' ) ?>" class="basket-continue">Continue Shopping</a>

		</div>

		<div class="cart-subtotal_box flex">
...
<div class="wc-proceed-to-checkout basket-totals ">
